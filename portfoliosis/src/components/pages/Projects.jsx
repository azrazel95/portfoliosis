    ...
    <>
      ...
      <ol>
        {props.projects.map(project => (
          <li className="border-l-2 mx-50  border-yellow-300">
            <div className="md:flex flex-start">
              <div className="bg-gray-600 w-6 h-6 flex items-center justify-center rounded-full -ml-3.5">
              </div>
              <div className="block p-6 rounded-lg  bg-gray-700 max-w-full ml-6 mb-10">
